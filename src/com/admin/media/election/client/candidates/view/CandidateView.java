package com.admin.media.election.client.candidates.view;
...
public class CandidateView extends Composite implements CandidatePresenter.Display{

	private static OrphanViewUiBinder uiBinder = GWT
			.create(OrphanViewUiBinder.class);

	interface OrphanViewUiBinder extends UiBinder<Widget, CandidateView> {
	}
